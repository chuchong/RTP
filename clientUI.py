...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.qualityEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.qualityEdit.setGeometry(QtCore.QRect(560, 720, 113, 21))
        self.qualityEdit.setObjectName("qualityEdit")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(440, 710, 141, 21))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(450, 730, 91, 16))
        self.label_4.setObjectName("label_4")
        self.setQualityB = QtWidgets.QPushButton(self.centralwidget)
        self.setQualityB.setGeometry(QtCore.QRect(680, 720, 88, 23))
        self.setQualityB.setObjectName("setQualityB")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wait.setText(_translate("MainWindow", "等待加载视频"))
        self.label_3.setText(_translate("MainWindow", "请输入视频质量"))
        self.label_4.setText(_translate("MainWindow", "范围:0-100"))
        self.setQualityB.setText(_translate("MainWindow", "选好质量了"))
