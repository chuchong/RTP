...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.init.setGeometry(QtCore.QRect(20, 390, 211, 81))
        self.init.setObjectName("init")
        self.play = QtWidgets.QPushButton(self.centralwidget)
        self.play.setGeometry(QtCore.QRect(240, 390, 211, 81))
        self.play.setObjectName("play")
        self.pause = QtWidgets.QPushButton(self.centralwidget)
        self.pause.setGeometry(QtCore.QRect(460, 390, 211, 81))
        self.pause.setObjectName("pause")
        self.teardown = QtWidgets.QPushButton(self.centralwidget)
        self.teardown.setGeometry(QtCore.QRect(680, 390, 201, 81))
        ...
        self.speedBox.setGeometry(QtCore.QRect(110, 490, 87, 22))
